...
export default function Dashboard() {
  ...
  const confirmOrder = async (id) => {
    ...
    try {
      await client.patch(`/orders/${id}/confirm`);
      fetchData();
    } catch (err) {
  ...
  const ignoreOrder = async (id) => {
    const reason = prompt("Why are you ignoring this order?");

    if (!reason) return;

    try {
      await client.patch(`/orders/${id}/ignore`, { reason });
      fetchData();
    } catch (err) {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h1
          className="font-display displayyy text-4xl font-bold mb-2"
          style={{ color: "#fafafa" }}
        >
          Dashboard
        </h1>
        <p className="text-sm mb-10" style={{ color: "#888" }}>
          Admin panel — Godfest 2026
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            ...
            {
              label: "Total Raised",
              value: `GH₵ ${data?.totalDonations ?? 0}`,
            },
          ].map(({ label, value }) => (
            <div
              key={label}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            <div className="flex items-center justify-between mb-5">
              <h2
                className="font-display displayyy text-xl font-bold"
                style={{ color: "#fafafa" }}
              >
                Registrations
                <span
            ...
            >
              ...
              {filteredAttendees?.map((a) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <span
                        ...
                        style={{
                          background:
                            a.ticketType === "vip" ? "#e91e8c22" : "#ffffff11",
                  ...
                  <button
                    onClick={() =>
                      deleteAttendee(a._id, `${a.firstName} ${a.lastName}`)
                    }
          ...
          <div>
            ...
            >
              ...
              <div>
                <label className="text-xs block mb-2" style={{ color: "#888" }}>
                  PRODUCT IMAGE
                </label>
                <input
                  type="file"
            ...
            <h2
              className="font-display displayyy text-xl font-bold mt-8 mb-4"
              style={{ color: "#fafafa" }}
            >
              Products
            </h2>
