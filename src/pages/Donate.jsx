...
export default function Donate() {
  ...
  const handleSubmit = async (e) => {
    ...
    setStatus("loading");
    try {
      const res = await client.post("/donate", {
        ...form,
    ...
    >
      <div className="max-w-xl mx-auto">
        ...
        <p className="text-center text-sm mb-12" style={{ color: "#888" }}>
          Your generosity makes this program possible. Every contribution
          counts.
        </p>
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Leave an encouraging word..."
              rows={3}
          ...
          {status === "success" && (
            ...
            >
              <p className="font-bold mb-2">Donation request submitted.</p>
              <p>Please send GH₵ {form.amount} to:</p>
              <p>
                <strong>MoMo Number:</strong> 0240000000
              </p>
              <p>
                <strong>Account Name:</strong> GODFEST
              </p>
              <p className="mt-2">
                Your donation will be confirmed after payment is received.
              </p>
            </div>
          )}
          {status === "error" && (
          ...
          >
            {status === "loading"
              ? "Submitting..."
              : `Give ${form.amount ? "GH₵ " + form.amount : "Now"}`}
          </button>
        </form>
      </div>
    </main>
